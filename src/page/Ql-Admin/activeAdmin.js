    ...
    return (
        <>
            <div className="active-admin-wrapper">
                <div className="logo">
                    <img alt="" src={logo} />
                    <h3 className="active-title"> Tên logo</h3>
                </div>
                            ...
                            <Collapse className="collapse-body" expandIconPosition="right">
                                <Panel header="Quy tắc đặt mật khẩu">
                                    <p className="collapse-content">
                                        Để bảo mật cho tài khoản của bạn, vui lòng đặt mật khẩu theo quy tắc:
                                    </p>
                                    <ul className="collapse-item">
                                        <li className="collapse-des">Tối thiểu 8 kí tự. </li>
                                        <li className="collapse-des">Mật khẩu bao gồm ít nhất 1 kí tự hoa, 1 kí tự thường và 1 kí tự đặc biệt.</li>
                                    </ul>
                                </Panel>
                            </Collapse>
                        </Form.Item>
                        <Form.Item>
                            <Button type="primary" danger htmlType="submit" className="button-active-user" >
                                Xác nhận
                            </Button>
                        </Form.Item>
                    </Form>
