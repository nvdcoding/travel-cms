            ...
            render: (_, record) => (
                <>
                    <div className="table-cell-action">
                        <Button type="primary" className='button-accept button-primary' danger onClick={() => acceptHDV(record)}>Chấp nhận</Button>
                        <Button className='button-deny button-nomal' onClick={() => denyHDV(record)}>Từ chối</Button>
